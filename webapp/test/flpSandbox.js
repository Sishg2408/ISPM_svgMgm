		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsvgcwispm-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsvgcwispm-display": {
								"semanticObject": "comsvgcwispm",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.svg.cwispm",
									"url": sap.ui.require.toUrl("com/svg/cwispm")
								}
							}
						}
					}
